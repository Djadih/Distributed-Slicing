...
public class Slice {
    ...
    Function<ConsistentCut, Boolean> predicate; // context 2: the predicate of interest
    ...
    public Slice(Computation computation, Function<ConsistentCut, Boolean> predicate, ConsistentCut V, Node[] nodes, boolean[][] incidenceMatrix) {
